...
class MapViewControllerS3: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(MapViewControllerS3.dismissKeyboard))
    ...
    @IBAction func Accept(_ sender: Any) {
        ...
        ref?.child("users").child(FIRAuth.auth()!.currentUser!.uid).child("Scorecard3").child("Hole1").setValue(textView.text)
